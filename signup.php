    ...
    <div class="container-fluid p-5 mainContainer">
        <div class="row mb-5">
            ...
            <div class="col-md-8 d-flex justify-content-end align-items-center">
                ...
                <a href="./login.php" class="btn btn-outline-success text-decoration-none me-3 navmenu">Log In</a>
            </div>
        </div>
        <div class="row d-flex justify-content-center align-items-center">
            ...
            <div class="col-md-5 ms-4 d-flex justify-content-center align-items-center border"> 
                <div class="row">
                    ...
                    <p class="text-center" style="font-size: 28px;">Already have an account? <a href="./login.php" class="text-decoration-none coloredText">Log In</a></p>
                    <form>
                        <div class="mb-3">
